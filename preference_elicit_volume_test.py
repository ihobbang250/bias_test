...
def run_experiment(llm_client: LLMClient, 
    ...
    # Set output path
    output_path = os.path.join(output_dir, f"{llm_client.short_model_id}_equal_set_{set_number}.csv")

    # Load data
    ticker_df = pd.read_csv(ticker_path)

    ticker_df = ticker_df[:10].copy() #### TESTING ONLY ####
